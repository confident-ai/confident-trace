...
Install: pip install -e './python[agentcore]' 'strands-agents[otel]'
...
init(
    ...
    # Strands already instruments inference; do not also wrap its Bedrock calls.
    instrumentations=("agentcore",),
)
