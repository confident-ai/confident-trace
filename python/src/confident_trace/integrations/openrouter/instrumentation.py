"""Instrument the native openrouter SDK using its OpenAI-compatible payloads."""
...
TARGETS = [
    ("openrouter.chat", "Chat", "send"),
    ("openrouter.chat", "Chat", "send_async"),
]
...
def begin(params, instance=None):
    return begin_call(
        ...
        params,
        instance,
        lambda _: {ai.GEN_AI_PROVIDER_NAME: "openrouter", SPAN_TYPE: "llm"},
        request,
